...
thetis_dir = global_params_tsunami.output_dir
...
t_end = global_params_tsunami.end_time #40 days (i.e. 30 days of analysis)
...
options.manning_drag_coefficient = global_params_tsunami.manning_drag_coefficient
options.horizontal_viscosity = global_params_tsunami.horizontal_viscosity
