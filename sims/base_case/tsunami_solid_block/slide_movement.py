...
b = params.slide_breadth
# Slide width - side-to-side
w = params.slide_width
# Slide max thickness
max_h = params.slide_max_thickness
# start x-location
slide_start_x = 725000+(b/2.)##don't know whether to change these
# start y-location
slide_start_y = 0##don't know whether to change these
# terminal velocity
ut = params.terminal_velocity
# grav acceleration
g = 9.81
