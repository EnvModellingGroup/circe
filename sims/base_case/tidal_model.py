...
dt = params.time_step # reduce if solver does not converge
...
options.wetting_and_drying_alpha_min = params.alpha_min
options.wetting_and_drying_alpha_max = params.alpha_max
